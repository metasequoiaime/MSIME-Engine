...
// Shared by both endpoints; do not copy this implementation into a platform repo.
...
constexpr std::size_t kPacketChars = FanyImePipeLimits::CandidateTextCapacity;
