...
{
  public:
    explicit PinyinCandidateProvider(const ShuangpinProfile &shuangpin_profile = GetXiaoheShuangpinProfile(), metasequoia::RuntimePaths paths = metasequoia::RuntimePaths::legacy());
    ...
    void set_helpcode_keymap(HelpcodeUtils::SharedKeymap table) { quanpin_engine_.set_helpcode_keymap(table); shuangpin_engine_.set_helpcode_keymap(std::move(table)); }
