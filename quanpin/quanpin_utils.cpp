...
const std::vector<std::string> &intact_pinyin_list()
{
    static const std::vector<std::string> kList = {
        ...
        "jue",  "jun",   "jv",   "jve",   "ka",    "kai",   "kan",  "kang",  "kao",   "ke",    "kei",    "ken",  "keng",
        ...
        "qing", "qiong", "qiu",   "qu",    "quan",  "que",  "qun",   "qv",    "qve",   "ran",   "rang",   "rao",  "re",
        ...
        "xuan", "xue",   "xun",   "xv",   "xve",   "ya",    "yan",  "yang",  "yao",   "ye",    "yi",     "yin",  "ying",
        "yo",   "yong",  "you",   "yu",    "yuan",  "yue",  "yun",   "yv",   "yve",   "za",    "zai",    "zan",  "zang",
