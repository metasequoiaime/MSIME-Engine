...
本仓默认分支是 `main`，日常改动从 `main` 切分支并合回 `main`，发布工作流也监听 `main`。平台仓的 gitlink 指向本仓 `main` 上已合并的提交，规则见[组织 AGENTS.md 的分支模型](https://github.com/metasequoiaime/.github/blob/main/AGENTS.md#分支模型)。
