...
{
std::string jianpin_ranking_context(const std::string &code, SchemeType scheme = SchemeType::Quanpin,
                                    const ShuangpinProfile &profile = GetXiaoheShuangpinProfile());

LocalQueryResult query_jianpin(const std::string &code, SchemeType scheme, int limit = 100,
                               const ShuangpinProfile &profile = GetXiaoheShuangpinProfile());
